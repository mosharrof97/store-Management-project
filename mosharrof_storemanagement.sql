...
--
-- Host: localhost
-- Generation Time: Jul 09, 2023 at 06:58 AM
...
--
-- Database: `mosharrof_storemanagement`
--
...
(1100, 'roby', 'Mirpur', '01987261151', 'roby@gmail.com', 0);
...
(76, 1094, 23, '2023-07-03 01:19:30', 1),
(77, 1094, 23, '2023-07-03 02:10:48', 1),
(78, 1095, 24, '2023-07-03 02:26:52', 1),
(79, 1096, 24, '2023-07-03 02:33:26', 1),
(80, 1097, 22, '2023-07-03 02:46:38', 1),
(81, 1098, 22, '2023-07-03 02:48:13', 1),
(82, 1099, 22, '2023-07-03 02:49:00', 1),
(83, 1100, 23, '2023-07-03 04:24:07', 1),
(84, 1094, 23, '2023-07-06 05:12:41', 1),
(85, 1094, 23, '2023-07-06 06:41:40', 1),
...
--
ALTER TABLE `b_order_product`
  MODIFY `b_order_product_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=90;
...
--
ALTER TABLE `customers`
  MODIFY `customer_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1101;
...
--
ALTER TABLE `purchase_order`
  MODIFY `purchase_order_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46;
...
--
ALTER TABLE `sales_order`
  MODIFY `sales_order_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=88;
...
--
ALTER TABLE `suppliers`
  MODIFY `supplier_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT for table `s_order_product`
--
ALTER TABLE `s_order_product`
  MODIFY `s_order_product_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=218;
